...
<form action="yayinevi_eklendi.php" method="post" >
    Yayınevi Adı: <input type="text" name="YayineviAdi" style="position:relative;left:15px"><br><br>
    Yayınevi Web Sitesi: <textarea name="YayineviWebSitesi" rows="2" cols="50" style="position:relative;left:10px"></textarea><br><br>
    Yayinevi Mail Adresi: <input type="text" name="YayineviMailAdresi" ><br><br>
   
    <input type="submit" value="Yayınevi Ekle" style="text-align:center;">
</form>
<!-- KODLAR -->   
</main>
