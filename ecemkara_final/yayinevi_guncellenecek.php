<?php
    ...
    $sorgu = mysqli_query($baglanti, "SELECT * FROM yayineviveri WHERE YayineviNo = $guncellenecek");
...
<!-- KODLAR -->
<h1>Yayınevi Güncelleme</h1>
    <br>
<form action="yayinevi_guncellendi.php" method="post">
    Yayınevi Adı: <input type="text" name="YayineviAdi" style="position:relative;left:30px" value="<?php echo $satir["YayineviAdi"] ;?>"><br><br>
    Yayınevi URL: <input type="text" name="YayineviWebSitesi" style="position:relative;left:25px" value="<?php echo $satir["YayineviWebSitesi"] ;?>"><br><br>
    Yayınevi Mail Adresi: <textarea name="YayineviMailAdresi" rows="2" cols="50"><?php echo $satir["YayineviMailAdresi"]?></textarea><br><br>
