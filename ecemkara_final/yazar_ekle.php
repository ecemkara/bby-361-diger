...
<form action="yazar_eklendi.php" method="post">
    Yazar Adı: <input type="text" name="YazarAdi" style="position:relative;left:25px"><br><br>
    Yazar Soyadı: <input type="text" name="YazarSoyadi"><br><br>
    Yazar Web Adresi: <textarea name="YazarWebAdresi" rows="2" cols="50" style="position:relative;left:20px"></textarea><br><br>
    <input type="submit" value="Yazar Ekleme" style="text-align:center;background-color:#212121; color: white">
</form>
<!-- KODLAR -->   
</main>
