<?php
    ...
    $sorgu = "UPDATE yazarveri SET YazarAdi = '$YazarAdi', YazarSoyadi = '$YazarSoyadi', YazarWebAdresi = '$YazarWebAdresi' WHERE YazarNo = $YazarNo";

    if (mysqli_query($baglanti, $sorgu)) {
        $islemSonuc = "Kayıt güncellendi.";
    } else {
...
echo("<table border=1 width=80%>");
    ...
    echo("<td><b>Yazar Web Sitesi</b></td>");
