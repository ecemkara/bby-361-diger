<?php
    ...
    $sorgu = mysqli_query($baglanti, "SELECT * FROM yazarveri WHERE YazarNo= $guncellenecek");
...
<form action="yazar_guncellendi.php" method="post">
    ...
    Yazar Web Adresi: <textarea name="YazarWebAdresi" rows="2" cols="50"><?php echo $satir["YazarWebAdresi"]?></textarea><br><br>
    <input type="hidden" value="<?php echo $satir["YazarNo"] ;?>" name="YazarNo">
    <input type="submit" value="Yazar Kaydı Güncelleme" style="text-align:center;background-color:#212121; color: white">
</form>
<!-- KODLAR -->   
</main>
