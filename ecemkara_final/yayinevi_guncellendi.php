<?php
    ...
    $sorgu = "UPDATE yayineviveri SET YayineviAdi= '$YayineviAdi', YayineviWebSitesi  = '$YayineviWebSitesi ', YayineviMailAdresi = '$YayineviMailAdresi' WHERE YayineviNo= $YayineviNo";
...
while($satir = mysqli_fetch_assoc($sorgu2)){
    ...
    echo("<td><a href='yayinevi_guncellenecek.php?YayineviNo=".$satir["YayineviNo"]."'>Güncelleme</a></td>");
