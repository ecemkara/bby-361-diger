<?php
    ...
    $YazarWebAdresi = mysqli_real_escape_string($baglanti, $_POST['YazarWebAdresi']);
    $sorgu = "INSERT INTO yazarveri (YazarAdi, YazarSoyadi, YazarWebAdresi)
            VALUES ('$YazarAdi', '$YazarSoyadi', '$YazarWebAdresi')";
    ...
    $sorgu2 = mysqli_query($baglanti, "SELECT * FROM yazarveri ORDER BY YazarNo DESC");
...
<p><a href="yazar_ekle.php" style="text-align:center;background-color:#212121; color: white">Yazar Ekleme</a></p>
<?php
echo("<table border=1 width=80%>");
    ...
    echo("<td><b>Yazar Web Adresi</b></td>");
...
while($satir = mysqli_fetch_assoc($sorgu2)){
    ...
    echo("<td>".$satir["YazarWebAdresi"]."</td>");
    echo("<td><a href='guncellenecek.php?YazarNo=".$satir["YazarNo"]."'>Güncelle</a></td>");
    echo("<td><a href='sil.php?YazarNo=".$satir["YazarNo"]."'>Sil</a></td>");
    echo("</tr>");
            }
echo("</table>");
?>
