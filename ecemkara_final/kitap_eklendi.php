<?php
    ...
    $sorgu = "INSERT INTO kitapveri (KitapISBN, KitapAdi, FizikselOzellikler, KitapAdedi, BasildigiTarih, KitapDili, YayineviNo, YazarNo)
            VALUES ('$KitapISBN', '$KitapAdi', '$FizikselOzellikler', '$BasildigiTarih', '$KitapDili', '$YayineviNo', '$YazarNo', '$YazarNo')";


    if (mysqli_query($baglanti, $sorgu)) {
        $islemSonuc = "Kayıt Oluşturuldu.";
    } else {
        $islemSonuc = "Hata: " . $sorgu . "<br>" . mysqli_error($baglanti);
    }

    $sorgu2 = mysqli_query($baglanti, "SELECT * FROM kitapveri, yayineviveri, yazarveri");
