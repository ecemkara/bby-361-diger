<?php
    ...
    $silinecek = mysqli_real_escape_string($baglanti, $_GET["KitapKayitNo"]);
    $sorgu = "DELETE FROM kitapveri WHERE KitapKayitNo = '$silinecek'";

    if (mysqli_query($baglanti, $sorgu)) {
        $islemSonuc = "Silindi";
    } else {
        $islemSonuc = "Hata oluştu: " . mysqli_error($baglanti);
    }
